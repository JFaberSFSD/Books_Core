...
INSERT INTO `customers` VALUES (0,1,'John','Doe','JD@books.com'),(1,2,'Robin','Smith','Robin@books.com'),(2,3,'Gloria','Rodriguez','grodriquez@books.com');
...
CREATE TABLE `favorite_books` (
  ...
  KEY `ix_favorite_books_index` (`index`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `favorite_books` VALUES (0,1,1),(1,1,2),(2,1,3),(3,2,4),(4,2,5),(5,3,5),(6,3,6);
...
-- Dump completed on 2022-09-14 22:31:38
